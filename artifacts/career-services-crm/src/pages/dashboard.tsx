...
export default function Dashboard() {
  ...
  return <AppShell><div className="mx-auto max-w-[1500px] px-5 py-7 md:px-9 md:py-9">
      ...
      <div><div className="eyebrow mb-2 text-accent-foreground/70">{todayLabel}</div><h1 className="font-serif text-[32px] font-extrabold tracking-[-.055em] md:text-[40px]">Good morning, Maya<span className="text-accent">.</span></h1><p className="mt-2 max-w-lg text-sm text-muted-foreground">Your relationship desk is in good shape. Here’s what deserves your attention today.</p></div>
